...
public class MyApp3 {
	 ...
	 * 
	 * <pre>
	 * discover-logback>mvn exec:java -Dexec.args="src/main/java/com/toien/discover/logback/ch3/duplicate.xml" exec:java -Dexec.mainClass="com.toien.discover.logback.ch3.MyApp3"
	 * @param args
	 */
