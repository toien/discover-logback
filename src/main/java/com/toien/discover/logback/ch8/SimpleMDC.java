...
public class SimpleMDC {
	/**
	 * <pre>
	 * discover-logback>mvn -Dexec.mainClass="com.toien.discover.logback.ch8.SimpleMDC" exec:java
	 *
	 * @param args
	 * @throws Exception
	 */
	...
	static void configureViaXML_File() {
		...
		try {
			...
			lc.reset();
			URL url = Loader
					.getResourceBySelfClassLoader("com/toien/discover/logback/ch8/simpleMDC.xml");
