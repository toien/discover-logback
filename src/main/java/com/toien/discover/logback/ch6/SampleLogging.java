...
public class SampleLogging {
	 ...
	 * 
	 * <pre>
	 * discover-logback>mvn -Dexec.args="src/main/java/com/toien/discover/logback/ch6/sampleLayoutConfig.xml" -Dexec.mainClass="com.toien.discover.logback.ch6.SampleLogging" exec:java
	 * 
	 * @param args
	 */
